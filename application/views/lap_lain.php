...
<script type="text/javascript">
	...
	function lihat_laporan() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo site_url("laporan/lap_lain"); ?>',
			data: 'nis='+nis,
			dataType: 'json',
			success: function(data) {
				console.log(data);
				...
				$.each(data, function(i,field){
					...
					append($('<tr>').
						...
						append($('<td align="right">').append(field.kesiswaan)).
						append($('<td align="right">').append(field.daftar_ulang)).
						append($('<td align="right">').append(field.psg)).
						append($('<td align="right">').append(field.uts_uas)).
						append($('<td align="right">').append(field.unas)).
						append($('<td align="right">').append(field.lain_lain)).
