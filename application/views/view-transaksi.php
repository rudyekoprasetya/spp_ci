...
<div class="panel-body">
  <div class="row">
	<div class="col-lg-12">
	  <label>NIS </label>
<form method="POST" action="<?php echo site_url('transaksi/cari_siswa'); ?>"> 	
			<div class="form-group input-group">
		        <input type="text" class="form-control" placeholder="Masukan Nomor Induk Siswa" name="key" id="key">
...
<div class="row" >
  	...
  	<div class="col-lg-6">
		...
		<label>Bayar</label>
		<input type="text" class="form-control input-lg" name="bayar" id="bayar" name="bayar" onkeyup="kembali()" required="required">
		<label>Kembali</label>
		<input type="text" class="form-control input-lg" name="kembali" id="kembali" name="kembali" readonly="readonly" style="text-align:right;">
  	</div>
  	<div class="col-lg-6">
  		<label>Catatan</label>
		<textarea class="form-control" name="ket" id="ket">-</textarea>
		<label></label>
  		<a href="<?php echo site_url('transaksi'); ?>" class="btn btn-warning btn-lg btn-block" onclick="return confirm('Form Akan diKosongkan ?');"><i class="fa fa-file"></i> Transaksi Baru</a>
  		<button class="btn btn-success btn-lg btn-block" data-toggle="modal" data-target="#myModal" onclick="cetak()"><i class="fa fa-print"></i> Cetak Transaksi</button>
  	</div>
</div>
